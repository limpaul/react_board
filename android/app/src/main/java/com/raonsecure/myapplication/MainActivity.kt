    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginBtn.setOnClickListener {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                http.commonSendPostToServer(urlPath = "/api/order/user/login", dataMap = dataMap)
                    ?.let { response ->
                        ...
                        CoroutineScope(Dispatchers.Main).launch {
                            val builder =
                                AlertDialog.Builder(this@MainActivity) // MainActivity의 context 사용
                            builder.setTitle("로그인 결과")
                                ...
                                .setPositiveButton("확인") { dialog, _ ->
                                    ...
                                    if (resultMap.get("isSuccess") == true) {
                                        val intent: Intent =
                                            Intent(this@MainActivity, RestaurantList::class.java)
